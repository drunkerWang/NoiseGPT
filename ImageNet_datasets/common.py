...
class ImageFolderWithPaths(datasets.ImageFolder):
    def __init__(self, path, transform, flip_label_prob=0.0, classnames=None, exemplar=False, num_exemplar=None):
        ...
        # self.n = 0
        # for sample_path, target_label in self.samples:
        #     class_name = self.classes[target_label]
        #     self.n += 1
        #     print('classes from path: ', self.classes)
        #     print('classnames from path: ', class_name)
        ...
        # print('ImageFolderWithPaths classnames: ', len(self.classnames))
        if exemplar:
